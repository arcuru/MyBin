 ...
 */
int* primeListE(int);
int* primeListE_inc(int, const unsigned char*);
 ...
 */
int NextPrime(int, const unsigned char*);
...
unsigned char* primeIndexListE_inc(int, const unsigned char*);
...
int* primeFactorsE_inc(int, const int*);
 ...
 */
int isPrimeE(int, const unsigned char*);
